...
from src.api.analyze import router as analyze_api_router
...
app.include_router(analyze_api_router, prefix="/api/v1", tags=["Standalone Analysis"])
...
@app.get("/analyzer", tags=["Web UI"])
async def analyzer_ui() -> FileResponse:
    """Serve the standalone analyzer web UI."""
